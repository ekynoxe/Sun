...
Sun.prototype = {
     ...
     */
    calcSunRightAscension: function(lambda) {
     ...
     * @param: float lambda, the ecliptical longitude of the sun as seen from planet EARTH
     */
    calcSunDeclination: function(lambda) {
     ...
     */
    calcSunSiderealTime: function(J, lng) {
     ...
     */
    calcSunHourAngle: function(alpha, theta) {
        return theta - alpha;
    },
     ...
     */
    calcSunAzimuth: function(H, lat, delta) {
     ...
     * @param: float delta, the sun's declination
     */
    calcSunAltitude: function(H, lat, delta) {
     ...
     */
    calcTransit: function(sunsetHourAngle, M, lambda) {
     ...
     */
    calcSunsetHourAngle: function(lat, delta, h0) {
